...
RC CreateIndexStmt::create(Db *db, const CreateIndexSqlNode &create_index, Stmt *&stmt)
{
  ...
  if (create_index.attribute_name.size()==0||is_blank(table_name) || is_blank(create_index.index_name.c_str()) ||
  ...
  const FieldMeta *field_meta = table->table_meta().field(create_index.attribute_name[0].c_str());
